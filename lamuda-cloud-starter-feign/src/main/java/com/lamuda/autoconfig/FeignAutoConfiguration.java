...
import com.lamuda.cloud.feign.codec.CustomErrorDecoder;
import com.lamuda.cloud.feign.interceptors.AuthorizationRequestHeaderInterceptor;
import com.lamuda.cloud.feign.webflux.AttributeHolder;
...
@EnableFeignClients(basePackages = "${spring.cloud.openfeign.client.basePackage:com.lamuda.cloud}")
