...
import com.lamuda.cloud.liquibase.LiquibaseFinishedPublisher;
import com.lamuda.cloud.liquibase.LiquibasePostExecutor;
import com.lamuda.cloud.liquibase.LiquibaseProperties;
...
@ConditionalOnProperty(prefix = "lamuda.liquibase", name = "enabled", matchIfMissing = true)
public class LiquibaseAutoConfiguration {
    ...
    public SpringLiquibase liquibase(LiquibaseProperties properties) {
        ...
        liquibase.setChangeLog("classpath:META-INF/db/changelogs/lamuda-master.xml");
