...
import com.lamuda.cloud.mybatis.extend.ExtendLogicSqlInjector;
import com.lamuda.cloud.mybatis.interceptor.InsertBatchInterceptor;
import com.lamuda.cloud.mybatis.handler.GlobalMetaObjectHandler;
...
@Slf4j
@Configuration
@MapperScan("${mybatis-plus.mapperPackage:com.lamuda.cloud.**.mapper}")
