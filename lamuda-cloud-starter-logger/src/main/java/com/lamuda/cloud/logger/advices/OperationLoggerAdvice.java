package com.lamuda.cloud.logger.advices;
...
import com.lamuda.cloud.logger.context.LogContext;
import com.lamuda.cloud.logger.model.OperationBody;
import com.lamuda.cloud.logger.model.OperationDetail;
import com.lamuda.cloud.logger.service.OperationService;
...
public class OperationLoggerAdvice extends AbstractAdvice<OperationLog> {
    ...
    @Around("@annotation(com.lamuda.cloud.logger.annotation.OperationLog)")
