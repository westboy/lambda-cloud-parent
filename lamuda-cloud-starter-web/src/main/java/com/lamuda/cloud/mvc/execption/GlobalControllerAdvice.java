...
import com.lamuda.cloud.core.exception.feign.AbstractFeignException;
import com.lamuda.cloud.core.exception.feign.FeignArgumentNotValidException;
...
import com.lamuda.cloud.core.exception.IllegalArgumentException;
import com.lamuda.cloud.core.exception.IllegalStateException;
import com.lamuda.cloud.core.exception.IllegalAccessException;
...
public class GlobalControllerAdvice {
    ...
    private ErrorModel handler501(BusinessException exception,
        ...
        model.setMessage(exception.getMessage());
        model.setError(String.valueOf(exception.getCode()));
        return model;
    }
