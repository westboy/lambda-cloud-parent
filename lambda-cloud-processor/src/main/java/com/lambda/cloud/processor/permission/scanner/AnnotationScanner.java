...
public class AnnotationScanner {
    ...
    public List<String> scanRequestMapping(Element element) {
        ...
        // 检查 @RequestMapping
        paths.addAll(getAnnotationArrayValue(element, 
    ...
    public String scanHttpMethodMapping(Element element) {
        ...
        String method = getAnnotationValue(element, 
            "org.springframework.web.bind.annotation.RequestMapping", "method");
        if (method != null) {
    ...
    public String scanOperationSummary(Element element) {
        String summary = getAnnotationValue(element, 
    ...
    public List<String> scanSaCheckPermission(Element element) {
        return getAnnotationArrayValue(element, 
            "cn.dev33.satoken.annotation.SaCheckPermission", "value");
    }
    ...
    public List<String> scanSaCheckRole(Element element) {
        return getAnnotationArrayValue(element, 
            "cn.dev33.satoken.annotation.SaCheckRole", "value");
    }
    ...
    public String scanSaCheckRoleMode(Element element) {
        String mode = getAnnotationValue(element, 
            "cn.dev33.satoken.annotation.SaCheckRole", "mode");
    ...
    public boolean isDeprecated(Element element) {
        return hasAnnotation(element, "java.lang.Deprecated") ||
               ...
               "true".equals(getAnnotationValue(element, 
                   "io.swagger.v3.oas.annotations.Operation", "deprecated"));
    }
}
