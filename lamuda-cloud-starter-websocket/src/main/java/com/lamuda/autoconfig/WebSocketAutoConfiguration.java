...
import com.lamuda.cloud.websocket.ChannelStoreMode;
import com.lamuda.cloud.websocket.event.DefaultConnectEventServiceImpl;
import com.lamuda.cloud.websocket.event.WsConnectEventService;
import com.lamuda.cloud.websocket.interceptor.DefaultAuthenticationChannelInterceptor;
import com.lamuda.cloud.websocket.interceptor.IpHandshakeInterceptor;
import com.lamuda.cloud.websocket.repository.DefaultWebSocketChannelRepository;
import com.lamuda.cloud.websocket.repository.RedisWebSocketChannelRepository;
...
@ConditionalOnProperty(prefix = "lamuda.websocket", name = "enabled", matchIfMissing = true)
