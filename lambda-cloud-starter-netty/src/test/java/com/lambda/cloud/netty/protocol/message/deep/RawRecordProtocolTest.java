...
public class RawRecordProtocolTest {
    ...
    private static final String TEST_DATA6 =
            "";
    ...
    public void testParseTransactionRecordWithNewProtocol() {
        ...
        try {
            ...
            // 将十六进制字符串转换为字节数组
            byte[] bytes = HexUtil.decodeHex(TEST_DATA3);
