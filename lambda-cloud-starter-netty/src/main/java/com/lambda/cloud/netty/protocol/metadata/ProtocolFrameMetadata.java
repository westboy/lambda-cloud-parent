 ...
 * @author Jin
 */
public record ProtocolFrameMetadata(
        Class<?> messageClass,
     ...
     * @return 消息元数据
     */
    public static ProtocolFrameMetadata create(
            Class<?> messageClass, ProtocolFrame protocolMessage, List<ProtocolFieldMetadata> fields) {
        // 构建字段映射表
        ...
        return new ProtocolFrameMetadata(messageClass, protocolMessage, fields, fieldMap, totalLength);
    }
