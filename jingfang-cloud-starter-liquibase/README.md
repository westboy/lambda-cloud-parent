...
```xml
   <dependency>
       <groupId>com.jingfang.cloud</groupId>
       <artifactId>jingfang-cloud-starter-liquibase</artifactId>
...
总的changelog文件的文件名格式：jingfang-项目名简称-changelog.xml。例如：jingfang-core-changelog.xml
```
- resources
    - META-INF
        - db
...
- resources
    - META-INF
        - db
            - changelogs
              - init
                - jingfang-core-create-table.xml
                - jingfang-core-insert-data.xml
```
...
1. **changSet**标签：书写changset语句的外标签
    - id：**jingfang-项目名简称-年月日秒序号**(202407232501)。示例：jingfang-core-202407232501
    - author：作者名称。示例：echo
...
```xml
<changeSet id="jingfang-core-202407232501" author="echo">
