...
import com.lambda.cloud.ykc.message.v16.up.YkcV16ParkLockReplyUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16ParkLockControlUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("63", YkcV16ParkLockReplyUp.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16ParkLockReplyUp resp = new YkcV16ParkLockReplyUp();
        resp.setEquipmentId("32010200000001");
        resp.setConnectorId(1);
        resp.setControlResult(0);
        ...
        YkcV16ParkLockReplyUp detail = assertInstanceOf(YkcV16ParkLockReplyUp.class, parsed.getDetail());
