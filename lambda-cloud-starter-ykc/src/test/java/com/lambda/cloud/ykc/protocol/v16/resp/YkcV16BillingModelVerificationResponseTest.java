...
import com.lambda.cloud.ykc.message.v16.resp.YkcV16BillingModelVerificationResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16BillingModelVerificationResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("06", YkcV16BillingModelVerificationResponse.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16BillingModelVerificationResponse resp = new YkcV16BillingModelVerificationResponse();
        ...
        YkcV16BillingModelVerificationResponse detail =
                assertInstanceOf(YkcV16BillingModelVerificationResponse.class, parsed.getDetail());
