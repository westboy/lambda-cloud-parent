...
import com.lambda.cloud.ykc.message.v20.req.YkcV20BillingModelRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20BillingModelRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("09", YkcV20BillingModelRequest.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20BillingModelRequest detail = new YkcV20BillingModelRequest();
        detail.setEquipmentId("1234567890123");

        YkcV20BasePayload base = new YkcV20BasePayload();
        base.setStartFlag("68");
        base.setEncryptFlag("00");
        base.setFrameType("09");
        ...
        assertEquals("09", parsed.getFrameType());
        assertEquals(1, parsed.getSerialNumber());

        YkcV20BillingModelRequest parsedDetail = assertInstanceOf(YkcV20BillingModelRequest.class, parsed.getDetail());
