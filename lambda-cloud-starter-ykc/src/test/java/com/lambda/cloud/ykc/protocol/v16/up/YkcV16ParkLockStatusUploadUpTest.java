...
import com.lambda.cloud.ykc.message.v16.up.YkcV16ParkLockStatusUploadUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16ParkLockStatusUploadUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("61", YkcV16ParkLockStatusUploadUp.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16ParkLockStatusUploadUp resp = new YkcV16ParkLockStatusUploadUp();
        ...
        YkcV16ParkLockStatusUploadUp detail = assertInstanceOf(YkcV16ParkLockStatusUploadUp.class, parsed.getDetail());
