...
import com.lambda.cloud.ykc.message.v20.up.YkcV20BillingModelUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20BillingModelUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("09", YkcV20BillingModelUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20BillingModelUp req = new YkcV20BillingModelUp();
        ...
        YkcV20BillingModelUp detail = assertInstanceOf(YkcV20BillingModelUp.class, parsed.getDetail());
