...
import com.lambda.cloud.ykc.message.v20.req.YkcV20BmsErrorRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20BmsErrorRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("1B", YkcV20BmsErrorRequest.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20BmsErrorRequest detail = new YkcV20BmsErrorRequest();
        ...
        detail.setChargerIdentificationTimeout00(1);
        detail.setChargerIdentificationTimeoutAA(1);
        detail.setReserved1(1);
        detail.setTimeSyncAndMaxOutputTimeout(1);
        detail.setChargerReadyTimeout(1);
        detail.setReserved2(1);
        detail.setChargerStatusTimeout(1);
        detail.setChargerStopTimeout(1);
        detail.setReserved3(1);
        ...
        YkcV20BmsErrorRequest parsedDetail = assertInstanceOf(YkcV20BmsErrorRequest.class, parsed.getDetail());
