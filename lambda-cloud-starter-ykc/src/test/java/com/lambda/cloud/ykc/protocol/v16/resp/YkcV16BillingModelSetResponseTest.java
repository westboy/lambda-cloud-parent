...
import com.lambda.cloud.ykc.message.v16.resp.YkcV16BillingModelSetResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16BillingModelSetResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("57", YkcV16BillingModelSetResponse.class);
        ProtocolEngine<YkcV16BasePayload> engine = ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16BillingModelSetResponse resp = new YkcV16BillingModelSetResponse();
        ...
        base.setFrameType("57");
        base.setSerialNumber(9);
        base.setDetail(resp);
        ...
        assertEquals("57", parsed.getFrameType());
        assertEquals(9, parsed.getSerialNumber());

        YkcV16BillingModelSetResponse detail =
                assertInstanceOf(YkcV16BillingModelSetResponse.class, parsed.getDetail());
        assertEquals("32010200000001", detail.getEquipmentId());
        assertEquals(1, detail.getSetResult());
