...
import com.lambda.cloud.ykc.message.v16.resp.YkcV16ChargingHandshakeResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16ChargingHandshakeResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("15", YkcV16ChargingHandshakeResponse.class);
        ProtocolEngine<YkcV16BasePayload> engine = ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16ChargingHandshakeResponse resp = new YkcV16ChargingHandshakeResponse();
        ...
        resp.setBatteryPackSerial("00000000");
        resp.setYear(0);
        resp.setMonth(0);
        resp.setDay(0);
        resp.setChargeCount("000000");
        resp.setOwnershipTag(0);
        resp.setReserved(0);
        resp.setVin("");
        resp.setSoftwareVersion("0000000000000000");
        ...
        YkcV16ChargingHandshakeResponse detail =
                assertInstanceOf(YkcV16ChargingHandshakeResponse.class, parsed.getDetail());
