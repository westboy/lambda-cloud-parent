...
import com.lambda.cloud.ykc.message.v20.down.YkcV20ParkLockControlDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ParkLockControlDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("62", YkcV20ParkLockControlDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ParkLockControlDown resp = new YkcV20ParkLockControlDown();
        resp.setEquipmentId("15031412782305");
        resp.setConnectorId("01");
        resp.setLockAction("55");
