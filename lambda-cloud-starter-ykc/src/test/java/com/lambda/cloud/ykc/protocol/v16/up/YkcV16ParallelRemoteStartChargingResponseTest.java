...
import com.lambda.cloud.ykc.message.v16.up.YkcV16ParallelRemoteStartReplyUp;
...
public class YkcV16ParallelRemoteStartChargingResponseTest {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("A3", YkcV16ParallelRemoteStartReplyUp.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16ParallelRemoteStartReplyUp resp = new YkcV16ParallelRemoteStartReplyUp();
        ...
        YkcV16ParallelRemoteStartReplyUp detail =
                assertInstanceOf(YkcV16ParallelRemoteStartReplyUp.class, parsed.getDetail());
