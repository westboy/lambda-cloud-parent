...
import com.lambda.cloud.ykc.message.v20.up.YkcV20ChargerStartFinishedRequest;
...
public class YkcV20ChargerStartFinishedRequestTest {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ...
        YkcV20ChargerStartFinishedRequest parsedDetail =
                assertInstanceOf(YkcV20ChargerStartFinishedRequest.class, parsed.getDetail());
