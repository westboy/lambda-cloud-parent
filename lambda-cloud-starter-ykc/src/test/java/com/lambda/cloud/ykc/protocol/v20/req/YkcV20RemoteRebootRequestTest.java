...
import com.lambda.cloud.ykc.message.v20.req.YkcV20RemoteRebootRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20RemoteRebootRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("92", YkcV20RemoteRebootRequest.class);
        ProtocolEngine<YkcV20BasePayload> engine = ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20RemoteRebootRequest detail = new YkcV20RemoteRebootRequest();
        ...
        YkcV20RemoteRebootRequest parsedDetail = assertInstanceOf(YkcV20RemoteRebootRequest.class, parsed.getDetail());
