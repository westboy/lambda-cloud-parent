...
import com.lambda.cloud.ykc.message.v20.down.YkcV20ChargerStartFinishedDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ChargerStartFinishedDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("4E", YkcV20ChargerStartFinishedDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ChargerStartFinishedDown resp = new YkcV20ChargerStartFinishedDown();
        ...
        YkcV20ChargerStartFinishedDown detail =
                assertInstanceOf(YkcV20ChargerStartFinishedDown.class, parsed.getDetail());
