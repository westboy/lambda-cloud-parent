...
import com.lambda.cloud.ykc.message.v20.up.YkcV20ParkLockStatusUploadUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ParkLockStatusUploadUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("61", YkcV20ParkLockStatusUploadUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ParkLockStatusUploadUp resp = new YkcV20ParkLockStatusUploadUp();
        resp.setEquipmentId("15031412782305");
        resp.setConnectorId("01");
        resp.setParkLockStatus(85);
        resp.setParkingSpaceStatus(255);
        resp.setParkLockBatteryLevel(80);
