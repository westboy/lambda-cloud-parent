...
import com.lambda.cloud.ykc.message.v16.down.YkcV16OfflineCardClearDown;
...
public class YkcV16OfflineCardClearDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("46", YkcV16OfflineCardClearDown.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16OfflineCardClearDown req = new YkcV16OfflineCardClearDown();
        ...
        YkcV16OfflineCardClearDown detail = assertInstanceOf(YkcV16OfflineCardClearDown.class, parsed.getDetail());
