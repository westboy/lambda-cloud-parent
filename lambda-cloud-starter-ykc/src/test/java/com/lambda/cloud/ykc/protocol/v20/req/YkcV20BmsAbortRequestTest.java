...
import com.lambda.cloud.ykc.message.v20.req.YkcV20BmsAbortRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20BmsAbortRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("1D", YkcV20BmsAbortRequest.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20BmsAbortRequest detail = new YkcV20BmsAbortRequest();
        ...
        YkcV20BmsAbortRequest parsedDetail = assertInstanceOf(YkcV20BmsAbortRequest.class, parsed.getDetail());
