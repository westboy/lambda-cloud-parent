...
import com.lambda.cloud.ykc.message.v20.up.YkcV20ChargerStartFinishedUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ChargerStartFinishedUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("4F", YkcV20ChargerStartFinishedUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ChargerStartFinishedUp resp = new YkcV20ChargerStartFinishedUp();
        resp.setTransactionSerialNumber("55031412782305012018061910262392");
        resp.setEquipmentId("15031412782305");
        resp.setConnectorId("01");
        resp.setStartResult(0);
        resp.setFailReason(0);
        resp.setCurrentMeterValue("0000000000");
        resp.setMaxAllowChargeVoltage(7500);
        resp.setBmsProtocolVersion("010102");
        resp.setBatteryType(3);
