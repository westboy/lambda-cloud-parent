...
import com.lambda.cloud.ykc.message.v20.down.YkcV20PowerModifyDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20PowerModifyDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("52", YkcV20PowerModifyDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20PowerModifyDown resp = new YkcV20PowerModifyDown();
        resp.setEquipmentId("15031412782305");
        resp.setConnectorId("01");
        resp.setMaxPower(120);
        resp.setPriority(1);
        resp.setLimitTime(60);
