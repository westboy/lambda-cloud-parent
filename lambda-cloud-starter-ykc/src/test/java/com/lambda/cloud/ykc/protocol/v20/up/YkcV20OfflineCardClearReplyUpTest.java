...
import com.lambda.cloud.ykc.message.v20.up.YkcV20OfflineCardClearReplyUp;
...
public class YkcV20OfflineCardClearReplyUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("45", YkcV20OfflineCardClearReplyUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20OfflineCardClearReplyUp resp = new YkcV20OfflineCardClearReplyUp();
        resp.setEquipmentId("15031412782305");

        List<YkcV20OfflineCardClearResult> results = new ArrayList<>();
        YkcV20OfflineCardClearResult result1 = new YkcV20OfflineCardClearResult();
        result1.setPhysicalCardNo("0000000000000001");
        result1.setClearFlag(0);
        result1.setFailReason(0);
        results.add(result1);
        ...
        YkcV20OfflineCardClearReplyUp detail =
                assertInstanceOf(YkcV20OfflineCardClearReplyUp.class, parsed.getDetail());
