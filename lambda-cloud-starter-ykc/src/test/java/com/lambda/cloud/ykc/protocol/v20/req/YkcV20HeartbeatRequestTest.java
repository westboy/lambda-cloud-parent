...
import com.lambda.cloud.ykc.message.v20.req.YkcV20HeartbeatRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20HeartbeatRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("03", YkcV20HeartbeatRequest.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20HeartbeatRequest req = new YkcV20HeartbeatRequest();
        ...
        YkcV20HeartbeatRequest detail = assertInstanceOf(YkcV20HeartbeatRequest.class, parsed.getDetail());
