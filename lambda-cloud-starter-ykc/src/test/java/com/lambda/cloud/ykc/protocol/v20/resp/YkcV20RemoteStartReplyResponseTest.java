...
import com.lambda.cloud.ykc.message.v20.resp.YkcV20RemoteStartReplyResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20RemoteStartReplyResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("A7", YkcV20RemoteStartReplyResponse.class);
        ProtocolEngine<YkcV20BasePayload> engine = ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20RemoteStartReplyResponse detail = new YkcV20RemoteStartReplyResponse();
        ...
        assertEquals("A7", parsed.getFrameType());
        assertEquals(1, parsed.getSerialNumber());

        YkcV20RemoteStartReplyResponse parsedDetail = assertInstanceOf(YkcV20RemoteStartReplyResponse.class, parsed.getDetail());
