...
import com.lambda.cloud.ykc.message.v20.up.YkcV20ErrorReportUp;
...
public class YkcV20ErrorReportUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("50", YkcV20ErrorReportUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ErrorReportUp resp = new YkcV20ErrorReportUp();
        resp.setEquipmentId("15031412782305");
        resp.setConnectorId("01");
        resp.setFaultType(4);
        resp.setFaultCode(1);
        resp.setFaultTime(LocalDateTime.of(2025, 1, 1, 12, 0, 0));
