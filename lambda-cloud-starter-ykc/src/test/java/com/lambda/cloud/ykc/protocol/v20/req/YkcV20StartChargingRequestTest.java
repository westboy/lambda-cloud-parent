...
import com.lambda.cloud.ykc.message.v20.req.YkcV20StartChargingRequest;
...
public class YkcV20StartChargingRequestTest {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ...
        YkcV20StartChargingRequest parsedDetail = assertInstanceOf(YkcV20StartChargingRequest.class, parsed.getDetail());
