...
import com.lambda.cloud.ykc.message.v16.down.YkcV16RemoteStopChargingDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16RemoteStopChargingDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("36", YkcV16RemoteStopChargingDown.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16RemoteStopChargingDown req = new YkcV16RemoteStopChargingDown();
        ...
        YkcV16RemoteStopChargingDown detail = assertInstanceOf(YkcV16RemoteStopChargingDown.class, parsed.getDetail());
