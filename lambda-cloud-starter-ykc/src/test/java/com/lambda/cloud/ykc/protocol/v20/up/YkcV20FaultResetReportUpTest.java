...
import com.lambda.cloud.ykc.message.v20.up.YkcV20FaultResetReportUp;
...
public class YkcV20FaultResetReportUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("4B", YkcV20FaultResetReportUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20FaultResetReportUp resp = new YkcV20FaultResetReportUp();
        resp.setEquipmentId("15031412782305");
        resp.setConnectorId("01");
        resp.setFaultType(4);
        resp.setFaultCode(1);
        resp.setResetTime(LocalDateTime.of(2025, 1, 1, 12, 0, 0));
        ...
        YkcV20FaultResetReportUp detail = assertInstanceOf(YkcV20FaultResetReportUp.class, parsed.getDetail());
