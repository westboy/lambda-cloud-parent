...
import com.lambda.cloud.ykc.message.v16.down.YkcV16BillingModelSetDown;
...
public class YkcV16BillingModelSetDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("58", YkcV16BillingModelSetDown.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16BillingModelSetDown req = new YkcV16BillingModelSetDown();
        ...
        YkcV16BillingModelSetDown detail = assertInstanceOf(YkcV16BillingModelSetDown.class, parsed.getDetail());
