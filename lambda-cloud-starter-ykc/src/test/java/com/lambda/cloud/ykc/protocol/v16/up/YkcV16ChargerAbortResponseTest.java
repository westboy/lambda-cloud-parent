...
import com.lambda.cloud.ykc.message.v16.up.YkcV16ChargerAbortUp;
...
public class YkcV16ChargerAbortResponseTest {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("21", YkcV16ChargerAbortUp.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16ChargerAbortUp resp = new YkcV16ChargerAbortUp();
        ...
        YkcV16ChargerAbortUp detail = assertInstanceOf(YkcV16ChargerAbortUp.class, parsed.getDetail());
