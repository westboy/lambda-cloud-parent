...
import com.lambda.cloud.ykc.message.v20.up.YkcV20PowerModifyReplyUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20PowerModifyReplyUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("51", YkcV20PowerModifyReplyUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20PowerModifyReplyUp resp = new YkcV20PowerModifyReplyUp();
        ...
        YkcV20PowerModifyReplyUp detail = assertInstanceOf(YkcV20PowerModifyReplyUp.class, parsed.getDetail());
