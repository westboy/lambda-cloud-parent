...
import com.lambda.cloud.ykc.message.v20.req.YkcV20ChargingEndRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ChargingEndRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("19", YkcV20ChargingEndRequest.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ChargingEndRequest detail = new YkcV20ChargingEndRequest();
        ...
        detail.setBmsEndSoc(1);
        detail.setBmsMinCellVoltage(300);
        detail.setBmsMaxCellVoltage(300);
        detail.setBmsMinTemperature(1);
        detail.setBmsMaxTemperature(1);
        detail.setChargingDuration(300);
        detail.setOutputEnergy(300);
        ...
        YkcV20ChargingEndRequest parsedDetail = assertInstanceOf(YkcV20ChargingEndRequest.class, parsed.getDetail());
