...
import com.lambda.cloud.ykc.message.v20.down.YkcV20ParallelStartChargingDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ParallelStartChargingDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("A2", YkcV20ParallelStartChargingDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ParallelStartChargingDown resp = new YkcV20ParallelStartChargingDown();
        ...
        YkcV20ParallelStartChargingDown detail =
