...
import com.lambda.cloud.ykc.message.v20.resp.YkcV20PowerModifyResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20PowerModifyResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("51", YkcV20PowerModifyResponse.class);
        ProtocolEngine<YkcV20BasePayload> engine = ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20PowerModifyResponse detail = new YkcV20PowerModifyResponse();
        ...
        YkcV20PowerModifyResponse parsedDetail = assertInstanceOf(YkcV20PowerModifyResponse.class, parsed.getDetail());
