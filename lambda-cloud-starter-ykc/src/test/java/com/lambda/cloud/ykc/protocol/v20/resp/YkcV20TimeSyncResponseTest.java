...
import com.lambda.cloud.ykc.message.v20.resp.YkcV20TimeSyncResponse;
...
public class YkcV20TimeSyncResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("55", YkcV20TimeSyncResponse.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20TimeSyncResponse detail = new YkcV20TimeSyncResponse();
        ...
        YkcV20TimeSyncResponse parsedDetail = assertInstanceOf(YkcV20TimeSyncResponse.class, parsed.getDetail());
