...
import com.lambda.cloud.ykc.message.v20.down.YkcV20TimeSyncDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20TimeSyncDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("56", YkcV20TimeSyncDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20TimeSyncDown resp = new YkcV20TimeSyncDown();
        resp.setEquipmentId("15031412782305");
        resp.setSyncTime("2025-01-01 12:00:00");
        ...
        YkcV20TimeSyncDown detail = assertInstanceOf(YkcV20TimeSyncDown.class, parsed.getDetail());
