...
import com.lambda.cloud.ykc.message.v20.down.YkcV20RemoteRebootDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20RemoteRebootDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("92", YkcV20RemoteRebootDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20RemoteRebootDown resp = new YkcV20RemoteRebootDown();
        ...
        YkcV20RemoteRebootDown detail = assertInstanceOf(YkcV20RemoteRebootDown.class, parsed.getDetail());
