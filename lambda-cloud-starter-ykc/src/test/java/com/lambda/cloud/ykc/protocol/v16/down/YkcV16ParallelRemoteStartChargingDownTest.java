...
import com.lambda.cloud.ykc.message.v16.down.YkcV16ParallelRemoteStartChargingDown;
...
public class YkcV16ParallelRemoteStartChargingDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("A4", YkcV16ParallelRemoteStartChargingDown.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16ParallelRemoteStartChargingDown req = new YkcV16ParallelRemoteStartChargingDown();
        ...
        req.setAccountBalance(new BigDecimal("1000.00"));
        ...
        YkcV16ParallelRemoteStartChargingDown detail =
                assertInstanceOf(YkcV16ParallelRemoteStartChargingDown.class, parsed.getDetail());
