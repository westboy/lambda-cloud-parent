...
import com.lambda.cloud.ykc.message.v20.down.YkcV20FaultResetReportConfirmDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20FaultResetReportConfirmDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("4A", YkcV20FaultResetReportConfirmDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20FaultResetReportConfirmDown resp = new YkcV20FaultResetReportConfirmDown();
