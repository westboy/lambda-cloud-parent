...
import com.lambda.cloud.ykc.message.v16.up.YkcV16OfflineCardQueryReplyUp;
...
public class YkcV16OfflineCardQueryUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldKeepAllItems() throws Exception {
        ProtocolPayloadRegistry.register("47", YkcV16OfflineCardQueryReplyUp.class);
        ...
        YkcV16OfflineCardQueryReplyUp resp = new YkcV16OfflineCardQueryReplyUp();
        ...
        YkcV16OfflineCardQueryReplyUp detail =
                assertInstanceOf(YkcV16OfflineCardQueryReplyUp.class, parsed.getDetail());
