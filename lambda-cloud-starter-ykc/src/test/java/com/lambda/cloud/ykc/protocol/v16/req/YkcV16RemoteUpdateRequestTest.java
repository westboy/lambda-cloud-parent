...
import com.lambda.cloud.ykc.message.v16.req.YkcV16RemoteUpdateRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16RemoteUpdateRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("94", YkcV16RemoteUpdateRequest.class);
        ProtocolEngine<YkcV16BasePayload> engine = ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16RemoteUpdateRequest req = new YkcV16RemoteUpdateRequest();
        ...
        YkcV16RemoteUpdateRequest detail = assertInstanceOf(YkcV16RemoteUpdateRequest.class, parsed.getDetail());
