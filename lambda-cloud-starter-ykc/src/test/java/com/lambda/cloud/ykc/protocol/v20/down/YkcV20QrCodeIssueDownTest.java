...
import com.lambda.cloud.ykc.message.v20.down.YkcV20QrCodeIssueDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20QrCodeIssueDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("5B", YkcV20QrCodeIssueDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20QrCodeIssueDown resp = new YkcV20QrCodeIssueDown();
        resp.setEquipmentId("15031412782305");
        resp.setConnectorId("01");
        resp.setQrCodeFormat(0);
        resp.setQrCodeLength(20);
        resp.setQrCode("https://example.com/qr");
