...
import com.lambda.cloud.ykc.message.v20.req.YkcV20RemoteStopRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20RemoteStopRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("36", YkcV20RemoteStopRequest.class);
        ProtocolEngine<YkcV20BasePayload> engine = ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20RemoteStopRequest detail = new YkcV20RemoteStopRequest();
        ...
        YkcV20RemoteStopRequest parsedDetail = assertInstanceOf(YkcV20RemoteStopRequest.class, parsed.getDetail());
