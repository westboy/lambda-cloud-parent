...
import com.lambda.cloud.ykc.message.v20.up.YkcV20RemoteUpdateReplyUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20RemoteUpdateReplyUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("93", YkcV20RemoteUpdateReplyUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20RemoteUpdateReplyUp resp = new YkcV20RemoteUpdateReplyUp();
        ...
        YkcV20RemoteUpdateReplyUp detail = assertInstanceOf(YkcV20RemoteUpdateReplyUp.class, parsed.getDetail());
