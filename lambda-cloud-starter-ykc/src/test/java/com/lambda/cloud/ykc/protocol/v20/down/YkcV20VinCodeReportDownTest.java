...
import com.lambda.cloud.ykc.message.v20.down.YkcV20VinCodeReportDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20VinCodeReportDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("AA", YkcV20VinCodeReportDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20VinCodeReportDown resp = new YkcV20VinCodeReportDown();
        ...
        YkcV20VinCodeReportDown detail = assertInstanceOf(YkcV20VinCodeReportDown.class, parsed.getDetail());
