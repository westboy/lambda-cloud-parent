...
import com.lambda.cloud.ykc.message.v20.up.YkcV20PlatformConnectConfigReplyUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20PlatformConnectConfigReplyUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("5C", YkcV20PlatformConnectConfigReplyUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20PlatformConnectConfigReplyUp resp = new YkcV20PlatformConnectConfigReplyUp();
        ...
        YkcV20PlatformConnectConfigReplyUp detail =
                assertInstanceOf(YkcV20PlatformConnectConfigReplyUp.class, parsed.getDetail());
