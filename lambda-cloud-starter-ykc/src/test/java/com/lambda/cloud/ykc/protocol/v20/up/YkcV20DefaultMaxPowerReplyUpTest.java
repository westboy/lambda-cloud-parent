...
import com.lambda.cloud.ykc.message.v20.up.YkcV20DefaultMaxPowerReplyUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20DefaultMaxPowerReplyUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("59", YkcV20DefaultMaxPowerReplyUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20DefaultMaxPowerReplyUp resp = new YkcV20DefaultMaxPowerReplyUp();
        ...
        YkcV20DefaultMaxPowerReplyUp detail = assertInstanceOf(YkcV20DefaultMaxPowerReplyUp.class, parsed.getDetail());
