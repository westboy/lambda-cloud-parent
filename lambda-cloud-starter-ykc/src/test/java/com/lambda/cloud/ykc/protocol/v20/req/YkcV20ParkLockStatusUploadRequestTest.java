...
import com.lambda.cloud.ykc.message.v20.req.YkcV20ParkLockStatusUploadRequest;
...
public class YkcV20ParkLockStatusUploadRequestTest {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ...
        detail.setParkLockStatus(1);
        detail.setParkingStatus(1);
        detail.setBatteryLevel(1);
        detail.setAlarmStatus(1);
