...
import com.lambda.cloud.ykc.message.v20.down.YkcV20TransactionRecordConfirmDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20TransactionRecordConfirmDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("40", YkcV20TransactionRecordConfirmDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20TransactionRecordConfirmDown resp = new YkcV20TransactionRecordConfirmDown();
        ...
        YkcV20TransactionRecordConfirmDown detail =
                assertInstanceOf(YkcV20TransactionRecordConfirmDown.class, parsed.getDetail());
