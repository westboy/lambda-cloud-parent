...
import com.lambda.cloud.ykc.message.v16.up.YkcV16OfflineCardClearReplyUp;
...
public class YkcV16OfflineCardClearUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldKeepAllItems() throws Exception {
        ProtocolPayloadRegistry.register("45", YkcV16OfflineCardClearReplyUp.class);
        ...
        YkcV16OfflineCardClearReplyUp resp = new YkcV16OfflineCardClearReplyUp();
        ...
        YkcV16OfflineCardClearReplyUp detail =
                assertInstanceOf(YkcV16OfflineCardClearReplyUp.class, parsed.getDetail());
