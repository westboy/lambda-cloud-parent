...
import com.lambda.cloud.ykc.message.v16.resp.YkcV16ParallelRemoteStartChargingResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16ParallelRemoteStartChargingResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ...
        assertEquals("A3", parsed.getFrameType());
        assertEquals(512, parsed.getSerialNumber());

        YkcV16ParallelRemoteStartChargingResponse detail =
                assertInstanceOf(YkcV16ParallelRemoteStartChargingResponse.class, parsed.getDetail());
