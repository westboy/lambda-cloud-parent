...
import com.lambda.cloud.ykc.message.v20.req.YkcV20PowerModifyRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20PowerModifyRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ...
        assertEquals("52", parsed.getFrameType());
        assertEquals(1, parsed.getSerialNumber());

        YkcV20PowerModifyRequest parsedDetail = assertInstanceOf(YkcV20PowerModifyRequest.class, parsed.getDetail());
        assertEquals("1234567890123", parsedDetail.getEquipmentId());
        assertEquals("1", parsedDetail.getConnectorId());
        assertEquals(300, parsedDetail.getMaxPower());
