...
import com.lambda.cloud.ykc.message.v16.resp.YkcV16RemoteUpdateResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16RemoteUpdateResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ...
        assertEquals(18, parsed.getSerialNumber());

        YkcV16RemoteUpdateResponse detail = assertInstanceOf(YkcV16RemoteUpdateResponse.class, parsed.getDetail());
        assertEquals("32010200000001", detail.getEquipmentId());
        assertEquals(1, detail.getUpdateStatus());
