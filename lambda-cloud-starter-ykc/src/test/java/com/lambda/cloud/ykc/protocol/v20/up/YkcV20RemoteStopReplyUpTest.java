...
import com.lambda.cloud.ykc.message.v20.up.YkcV20RemoteStopReplyUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20RemoteStopReplyUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("35", YkcV20RemoteStopReplyUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20RemoteStopReplyUp resp = new YkcV20RemoteStopReplyUp();
        ...
        YkcV20RemoteStopReplyUp detail = assertInstanceOf(YkcV20RemoteStopReplyUp.class, parsed.getDetail());
