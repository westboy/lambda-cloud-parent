...
import com.lambda.cloud.ykc.message.v16.up.YkcV16BillingModelUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16BillingModelDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("09", YkcV16BillingModelUp.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16BillingModelUp req = new YkcV16BillingModelUp();
        ...
        YkcV16BillingModelUp detail = assertInstanceOf(YkcV16BillingModelUp.class, parsed.getDetail());
