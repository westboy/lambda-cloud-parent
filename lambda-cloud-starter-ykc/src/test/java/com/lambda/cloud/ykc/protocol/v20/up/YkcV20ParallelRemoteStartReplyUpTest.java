...
import com.lambda.cloud.ykc.message.v20.up.YkcV20ParallelRemoteStartReplyUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ParallelRemoteStartReplyUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("A3", YkcV20ParallelRemoteStartReplyUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ParallelRemoteStartReplyUp resp = new YkcV20ParallelRemoteStartReplyUp();
        ...
        resp.setMasterSlaveMark(0);
        resp.setParallelSerialNumber("230619102623");
        ...
        YkcV20ParallelRemoteStartReplyUp detail =
                assertInstanceOf(YkcV20ParallelRemoteStartReplyUp.class, parsed.getDetail());
