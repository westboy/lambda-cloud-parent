...
import com.lambda.cloud.ykc.message.v20.up.YkcV20RemoteRebootReplyUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20RemoteRebootReplyUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("91", YkcV20RemoteRebootReplyUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20RemoteRebootReplyUp resp = new YkcV20RemoteRebootReplyUp();
        ...
        YkcV20RemoteRebootReplyUp detail = assertInstanceOf(YkcV20RemoteRebootReplyUp.class, parsed.getDetail());
