...
import com.lambda.cloud.ykc.message.v20.up.YkcV20BillingModelSetReplyUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20BillingModelSetReplyUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("57", YkcV20BillingModelSetReplyUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20BillingModelSetReplyUp resp = new YkcV20BillingModelSetReplyUp();
        ...
        YkcV20BillingModelSetReplyUp detail = assertInstanceOf(YkcV20BillingModelSetReplyUp.class, parsed.getDetail());
