...
public class YkcV16TransactionRecordRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ...
        YkcV16TransactionRecordRequest req = new YkcV16TransactionRecordRequest();
        ...
        YkcV16TransactionRecordRequest detail =
                assertInstanceOf(YkcV16TransactionRecordRequest.class, parsed.getDetail());
