...
import com.lambda.cloud.ykc.message.v16.req.YkcV16RemoteRebootRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16RemoteRebootRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("92", YkcV16RemoteRebootRequest.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16RemoteRebootRequest req = new YkcV16RemoteRebootRequest();
        req.setEquipmentId("32010200000001");
        req.setExecuteControl(1);

        YkcV16BasePayload base = new YkcV16BasePayload();
        base.setStartFlag("68");
        base.setEncryptFlag("00");
        base.setFrameType("92");
        base.setSerialNumber(17);
        base.setDetail(req);
        ...
        assertEquals("92", parsed.getFrameType());
        assertEquals(12, parsed.getDataLength());
        assertEquals(17, parsed.getSerialNumber());

        YkcV16RemoteRebootRequest detail = assertInstanceOf(YkcV16RemoteRebootRequest.class, parsed.getDetail());
