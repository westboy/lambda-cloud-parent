...
import com.lambda.cloud.ykc.message.v20.down.YkcV20WorkingParamsSetDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20WorkingParamsSetDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("5F", YkcV20WorkingParamsSetDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20WorkingParamsSetDown resp = new YkcV20WorkingParamsSetDown();
        resp.setEquipmentId("15031412782305");
        resp.setConnectorId("01");
        resp.setPlugAndChargeSwitch(0);
        resp.setAuthTimeout(30);
        resp.setOfflineChargingTime(0);

        YkcV20BasePayload base = new YkcV20BasePayload();
        base.setStartFlag("68");
        base.setEncryptFlag("00");
        base.setFrameType("5F");
