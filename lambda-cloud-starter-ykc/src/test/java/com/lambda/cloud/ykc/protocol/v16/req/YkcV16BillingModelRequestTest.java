...
import com.lambda.cloud.ykc.message.v16.req.YkcV16BillingModelRequest;
...
public class YkcV16BillingModelRequestTest {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ...
        YkcV16BillingModelRequest detail = assertInstanceOf(YkcV16BillingModelRequest.class, parsed.getDetail());
