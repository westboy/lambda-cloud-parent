...
import com.lambda.cloud.ykc.message.v16.req.YkcV16OfflineCardQueryRequest;
...
public class YkcV16OfflineCardQueryRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("48", YkcV16OfflineCardQueryRequest.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16OfflineCardQueryRequest req = new YkcV16OfflineCardQueryRequest();
        ...
        YkcV16OfflineCardQueryRequest detail =
                assertInstanceOf(YkcV16OfflineCardQueryRequest.class, parsed.getDetail());
