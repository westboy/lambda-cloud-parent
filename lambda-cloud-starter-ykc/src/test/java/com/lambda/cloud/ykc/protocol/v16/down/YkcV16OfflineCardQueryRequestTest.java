...
import com.lambda.cloud.ykc.message.v16.down.YkcV16OfflineCardQueryDown;
...
public class YkcV16OfflineCardQueryRequestTest {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("48", YkcV16OfflineCardQueryDown.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16OfflineCardQueryDown req = new YkcV16OfflineCardQueryDown();
        ...
        YkcV16OfflineCardQueryDown detail = assertInstanceOf(YkcV16OfflineCardQueryDown.class, parsed.getDetail());
