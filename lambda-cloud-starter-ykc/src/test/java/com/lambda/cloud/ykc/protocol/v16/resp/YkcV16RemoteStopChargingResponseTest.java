...
import com.lambda.cloud.ykc.message.v16.resp.YkcV16RemoteStopChargingResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16RemoteStopChargingResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("35", YkcV16RemoteStopChargingResponse.class);
        ProtocolEngine<YkcV16BasePayload> engine = ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16RemoteStopChargingResponse resp = new YkcV16RemoteStopChargingResponse();
        ...
        YkcV16RemoteStopChargingResponse detail =
                assertInstanceOf(YkcV16RemoteStopChargingResponse.class, parsed.getDetail());
