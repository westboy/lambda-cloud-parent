...
import com.lambda.cloud.ykc.message.v20.down.YkcV20ReadRealtimeDataDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ReadRealtimeDataDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("12", YkcV20ReadRealtimeDataDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ReadRealtimeDataDown resp = new YkcV20ReadRealtimeDataDown();
        ...
        YkcV20ReadRealtimeDataDown detail = assertInstanceOf(YkcV20ReadRealtimeDataDown.class, parsed.getDetail());
