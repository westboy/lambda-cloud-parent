...
import com.lambda.cloud.ykc.message.v16.down.YkcV16TransactionRecordConfirmDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16TransactionRecordDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("40", YkcV16TransactionRecordConfirmDown.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16TransactionRecordConfirmDown req = new YkcV16TransactionRecordConfirmDown();
        req.setTransactionId("55031412782305012018061910262392");
        req.setConfirmResult(0);
        ...
        YkcV16TransactionRecordConfirmDown detail =
                assertInstanceOf(YkcV16TransactionRecordConfirmDown.class, parsed.getDetail());
