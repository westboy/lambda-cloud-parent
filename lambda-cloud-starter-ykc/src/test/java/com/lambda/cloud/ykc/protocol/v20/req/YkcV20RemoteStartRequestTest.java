...
import com.lambda.cloud.ykc.message.v20.req.YkcV20RemoteStartRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20RemoteStartRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("A8", YkcV20RemoteStartRequest.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20RemoteStartRequest detail = new YkcV20RemoteStartRequest();
        ...
        YkcV20RemoteStartRequest parsedDetail = assertInstanceOf(YkcV20RemoteStartRequest.class, parsed.getDetail());
