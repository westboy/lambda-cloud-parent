...
import com.lambda.cloud.ykc.message.v20.down.YkcV20HeartbeatDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20HeartbeatDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("04", YkcV20HeartbeatDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20HeartbeatDown resp = new YkcV20HeartbeatDown();
        ...
        YkcV20HeartbeatDown detail = assertInstanceOf(YkcV20HeartbeatDown.class, parsed.getDetail());
