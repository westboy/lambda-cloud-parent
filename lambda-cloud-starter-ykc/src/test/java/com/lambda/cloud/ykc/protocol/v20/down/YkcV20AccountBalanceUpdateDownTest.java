...
import com.lambda.cloud.ykc.message.v20.down.YkcV20AccountBalanceUpdateDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20AccountBalanceUpdateDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("42", YkcV20AccountBalanceUpdateDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20AccountBalanceUpdateDown resp = new YkcV20AccountBalanceUpdateDown();
        resp.setEquipmentId("15031412782305");
        resp.setConnectorId("01");
        resp.setPhysicalCardNumber("0000000000000000");
        resp.setUpdatedBalance(20000);
