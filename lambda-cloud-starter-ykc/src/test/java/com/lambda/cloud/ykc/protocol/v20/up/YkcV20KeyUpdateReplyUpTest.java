...
import com.lambda.cloud.ykc.message.v20.up.YkcV20KeyUpdateReplyUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20KeyUpdateReplyUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("95", YkcV20KeyUpdateReplyUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20KeyUpdateReplyUp resp = new YkcV20KeyUpdateReplyUp();
        ...
        YkcV20KeyUpdateReplyUp detail = assertInstanceOf(YkcV20KeyUpdateReplyUp.class, parsed.getDetail());
