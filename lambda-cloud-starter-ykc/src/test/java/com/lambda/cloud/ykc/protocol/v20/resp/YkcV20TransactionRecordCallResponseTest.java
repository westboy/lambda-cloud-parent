...
import com.lambda.cloud.ykc.message.v20.resp.YkcV20TransactionRecordCallResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20TransactionRecordCallResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("4C", YkcV20TransactionRecordCallResponse.class);
        ProtocolEngine<YkcV20BasePayload> engine = ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20TransactionRecordCallResponse detail = new YkcV20TransactionRecordCallResponse();
        ...
        assertEquals("4C", parsed.getFrameType());
        assertEquals(1, parsed.getSerialNumber());

        YkcV20TransactionRecordCallResponse parsedDetail = assertInstanceOf(YkcV20TransactionRecordCallResponse.class, parsed.getDetail());
