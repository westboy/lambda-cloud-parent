...
import com.lambda.cloud.ykc.message.v20.down.YkcV20ErrorReportConfirmDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ErrorReportConfirmDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("49", YkcV20ErrorReportConfirmDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ErrorReportConfirmDown resp = new YkcV20ErrorReportConfirmDown();
        ...
        YkcV20ErrorReportConfirmDown detail = assertInstanceOf(YkcV20ErrorReportConfirmDown.class, parsed.getDetail());
