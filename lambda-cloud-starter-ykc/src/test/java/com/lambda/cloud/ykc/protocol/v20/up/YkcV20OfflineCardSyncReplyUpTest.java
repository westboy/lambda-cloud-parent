...
import com.lambda.cloud.ykc.message.v20.up.YkcV20OfflineCardSyncReplyUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20OfflineCardSyncReplyUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("43", YkcV20OfflineCardSyncReplyUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20OfflineCardSyncReplyUp resp = new YkcV20OfflineCardSyncReplyUp();
        ...
        YkcV20OfflineCardSyncReplyUp detail = assertInstanceOf(YkcV20OfflineCardSyncReplyUp.class, parsed.getDetail());
