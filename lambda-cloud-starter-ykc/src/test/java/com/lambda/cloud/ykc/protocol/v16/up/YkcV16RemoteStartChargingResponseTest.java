...
import com.lambda.cloud.ykc.message.v16.up.YkcV16RemoteStartReplyUp;
...
public class YkcV16RemoteStartChargingResponseTest {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("33", YkcV16RemoteStartReplyUp.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16RemoteStartReplyUp resp = new YkcV16RemoteStartReplyUp();
        ...
        YkcV16RemoteStartReplyUp detail = assertInstanceOf(YkcV16RemoteStartReplyUp.class, parsed.getDetail());
