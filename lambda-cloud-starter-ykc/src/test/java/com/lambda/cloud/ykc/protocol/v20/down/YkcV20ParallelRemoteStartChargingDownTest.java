...
import com.lambda.cloud.ykc.message.v20.down.YkcV20ParallelRemoteStartChargingDown;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ParallelRemoteStartChargingDownTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("A4", YkcV20ParallelRemoteStartChargingDown.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ParallelRemoteStartChargingDown resp = new YkcV20ParallelRemoteStartChargingDown();
        ...
        YkcV20ParallelRemoteStartChargingDown detail =
                assertInstanceOf(YkcV20ParallelRemoteStartChargingDown.class, parsed.getDetail());
