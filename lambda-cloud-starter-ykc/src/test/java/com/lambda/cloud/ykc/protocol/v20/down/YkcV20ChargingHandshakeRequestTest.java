...
import com.lambda.cloud.ykc.message.v20.up.YkcV20ChargingHandshakeRequest;
...
public class YkcV20ChargingHandshakeRequestTest {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ...
        YkcV20ChargingHandshakeRequest parsedDetail =
                assertInstanceOf(YkcV20ChargingHandshakeRequest.class, parsed.getDetail());
