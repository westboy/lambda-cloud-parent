...
import com.lambda.cloud.ykc.message.v20.resp.YkcV20HeartbeatResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20HeartbeatResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ...
        YkcV20HeartbeatResponse detail = assertInstanceOf(YkcV20HeartbeatResponse.class, parsed.getDetail());
        assertEquals("55031412782305", detail.getEquipmentId());
        assertEquals("1", detail.getConnectorId());
        assertEquals(0, detail.getHeartbeatResponse());
