...
import com.lambda.cloud.ykc.message.v16.resp.YkcV16HeartbeatResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16HeartbeatResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ...
        assertEquals("04", parsed.getFrameType());
        assertEquals(54, parsed.getSerialNumber());

        YkcV16HeartbeatResponse detail = assertInstanceOf(YkcV16HeartbeatResponse.class, parsed.getDetail());
        assertEquals("55031412782305", detail.getEquipmentId());
        assertEquals(1, detail.getConnectorId());
        assertEquals(0, detail.getHeartbeatAck());
