...
import com.lambda.cloud.ykc.message.v16.up.YkcV16OfflineCardSyncReplyUp;
...
public class YkcV16OfflineCardSyncResponseTest {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("43", YkcV16OfflineCardSyncReplyUp.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16OfflineCardSyncReplyUp resp = new YkcV16OfflineCardSyncReplyUp();
        resp.setEquipmentId("32010200000001");
        resp.setSyncResult(1);
        ...
        YkcV16OfflineCardSyncReplyUp detail = assertInstanceOf(YkcV16OfflineCardSyncReplyUp.class, parsed.getDetail());
        assertEquals("32010200000001", detail.getEquipmentId());
        assertEquals(1, detail.getSyncResult());
        assertEquals(0, detail.getFailureReason());
