...
import com.lambda.cloud.ykc.message.v20.resp.YkcV20ErrorReportResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ErrorReportResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("49", YkcV20ErrorReportResponse.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ErrorReportResponse detail = new YkcV20ErrorReportResponse();
        detail.setEquipmentId("1234567890123");
        detail.setConnectorId("1");
        detail.setConfirmFlag(1);

        YkcV20BasePayload base = new YkcV20BasePayload();
        base.setStartFlag("68");
        base.setEncryptFlag("00");
        base.setFrameType("49");
        ...
        assertEquals("49", parsed.getFrameType());
        assertEquals(1, parsed.getSerialNumber());

        YkcV20ErrorReportResponse parsedDetail = assertInstanceOf(YkcV20ErrorReportResponse.class, parsed.getDetail());
