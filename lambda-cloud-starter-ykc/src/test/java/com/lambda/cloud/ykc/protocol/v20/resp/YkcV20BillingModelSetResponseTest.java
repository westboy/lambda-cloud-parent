...
import com.lambda.cloud.ykc.message.v20.resp.YkcV20BillingModelSetResponse;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20BillingModelSetResponseTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("57", YkcV20BillingModelSetResponse.class);
        ProtocolEngine<YkcV20BasePayload> engine = ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20BillingModelSetResponse detail = new YkcV20BillingModelSetResponse();
        ...
        YkcV20BillingModelSetResponse parsedDetail = assertInstanceOf(YkcV20BillingModelSetResponse.class, parsed.getDetail());
