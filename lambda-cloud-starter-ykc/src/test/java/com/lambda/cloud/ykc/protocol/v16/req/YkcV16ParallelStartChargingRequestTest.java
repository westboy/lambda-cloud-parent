...
import com.lambda.cloud.ykc.message.v16.req.YkcV16ParallelStartChargingRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV16ParallelStartChargingRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("A1", YkcV16ParallelStartChargingRequest.class);
        ProtocolEngine<YkcV16BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV16ParallelStartChargingRequest req = new YkcV16ParallelStartChargingRequest();
        ...
        YkcV16ParallelStartChargingRequest detail =
                assertInstanceOf(YkcV16ParallelStartChargingRequest.class, parsed.getDetail());
