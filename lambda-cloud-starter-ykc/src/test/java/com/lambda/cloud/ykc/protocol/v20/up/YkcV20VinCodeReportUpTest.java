...
import com.lambda.cloud.ykc.message.v20.up.YkcV20VinCodeReportUp;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20VinCodeReportUpTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("A9", YkcV20VinCodeReportUp.class);
        ProtocolEngine<YkcV20BasePayload> engine =
                ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20VinCodeReportUp resp = new YkcV20VinCodeReportUp();
        resp.setEquipmentId("15031412782305");
        resp.setConnectorId("01");
        resp.setVin("12345678901234567");
        ...
        YkcV20VinCodeReportUp detail = assertInstanceOf(YkcV20VinCodeReportUp.class, parsed.getDetail());
        assertEquals("15031412782305", detail.getEquipmentId());
        assertEquals("1", detail.getConnectorId());
        assertEquals("12345678901234567", detail.getVin());
