...
import com.lambda.cloud.ykc.message.v20.req.YkcV20ParallelStartChargingConfirmRequest;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class YkcV20ParallelStartChargingConfirmRequestTest {
    @BeforeEach
    public void setUp() {
    ...
    public void serialize_thenParse_shouldRoundTrip() throws Exception {
        ProtocolPayloadRegistry.register("A2", YkcV20ParallelStartChargingConfirmRequest.class);
        ProtocolEngine<YkcV20BasePayload> engine = ProtocolEngineFactory.getEngine(ProtocolEngineFactory.EngineType.REFLECTION);

        YkcV20ParallelStartChargingConfirmRequest detail = new YkcV20ParallelStartChargingConfirmRequest();
        ...
        detail.setAuthResult(1);
        detail.setFailReason("01");
        ...
        YkcV20ParallelStartChargingConfirmRequest parsedDetail = assertInstanceOf(YkcV20ParallelStartChargingConfirmRequest.class, parsed.getDetail());
