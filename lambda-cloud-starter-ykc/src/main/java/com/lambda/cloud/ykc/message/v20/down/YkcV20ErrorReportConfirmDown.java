 ...
 * <p>
 * 帧类型码：0x49
 * 对应协议文档：8.20 设备故障上送回复确认
 * 数据传输方向：运营平台 → 充电桩（下行）
 * 功能：平台在接收到故障上送后，对上送信息进行回复
 * </p>
 *
 * @author zx
 */
...
@Setter
@ToString
@ProtocolPayload(frameType = "49", name = "设备故障上送回复确认", description = "平台对设备故障上送的回复确认")
public class YkcV20ErrorReportConfirmDown {
