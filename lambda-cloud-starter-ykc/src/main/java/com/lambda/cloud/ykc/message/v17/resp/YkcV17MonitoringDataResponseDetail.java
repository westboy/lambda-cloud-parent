...
@Getter
@Setter
@ProtocolFrame(frameType = "0x13", name = "上传实时监测数据", description = "上传实时监测数据响应消息体", version = "1.7")
public class YkcV17MonitoringDataResponseDetail {
     ...
     * 默认构造函数
     */
    public YkcV17MonitoringDataResponseDetail() {}
    ...
    public YkcV17MonitoringDataResponseDetail(
            ...
            Integer outputCurrent,
            Integer cableTemperature,
            String cableCode,
            Integer soc,
            Integer batteryMaxTemperature,
            Integer totalChargingTime,
            Integer remainingTime,
            Long chargingEnergy,
            Long lossAdjustedEnergy,
            Long chargedAmount,
            Integer hardwareFault) {
        this.transactionId = transactionId;
        this.stationCode = stationCode;
        this.connectorId = connectorId;
        this.status = status;
        this.gunInPlace = gunInPlace;
        this.gunPlugged = gunPlugged;
        this.outputVoltage = outputVoltage;
        this.outputCurrent = outputCurrent;
        this.cableTemperature = cableTemperature;
        this.cableCode = cableCode;
        this.soc = soc;
        this.batteryMaxTemperature = batteryMaxTemperature;
        this.totalChargingTime = totalChargingTime;
        this.remainingTime = remainingTime;
        this.chargingEnergy = chargingEnergy;
        this.lossAdjustedEnergy = lossAdjustedEnergy;
