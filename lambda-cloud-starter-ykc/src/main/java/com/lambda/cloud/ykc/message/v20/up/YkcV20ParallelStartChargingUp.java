...
/**
 * 云快充2.0协议 - 充电桩主动申请并充充电
 * <p>
 * 帧类型码：0xA1
 * 对应协议文档：12.1 充电桩主动申请并充充电
 * 数据传输方向：充电桩 → 运营平台（上行）
...
@Setter
@ToString
@ProtocolPayload(frameType = "A1", name = "充电桩主动申请并充充电", description = "充电桩主动向平台申请并充启动充电")
public class YkcV20ParallelStartChargingUp {
