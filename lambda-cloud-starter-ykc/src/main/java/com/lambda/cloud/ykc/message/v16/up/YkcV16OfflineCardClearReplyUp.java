...
/**
 * 云快充1.6协议 - 离线卡数据清除应答
 * 对应协议帧类型 0x45（充电桩->运营平台）
 */
@ToString
@Getter
@Setter
@ProtocolPayload(frameType = "0x45", name = "离线卡数据清除应答", description = "离线卡数据清除应答", version = "1.6")
public class YkcV16OfflineCardClearReplyUp {
