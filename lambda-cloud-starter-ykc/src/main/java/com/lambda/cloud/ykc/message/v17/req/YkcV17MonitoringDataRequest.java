...
@Getter
@Setter
@ProtocolPayload(frameType = "0x12", name = "读取实时监测数据请求", description = "读取实时监测数据请求消息体", version = "1.7")
public class YkcV17MonitoringDataRequest {
     ...
     * 默认构造函数
     */
    public YkcV17MonitoringDataRequest() {}
}
