 ...
 * 云快充1.6协议运营平台远程停机消息体
 * <p>
 * 对应协议帧类型 0x36，当用户通过远程停止充电时，发送本命令（平台->充电桩）
 * </p>
 *
 * @author Jin
 */
...
@Setter
@ToString
@ProtocolPayload(frameType = "0x36", name = "运营平台远程停机", description = "当用户通过远程停止充电时，发送本命令", version = "1.6")
public class YkcV16RemoteStopChargingDown {
