...
public class YkcV20LoginRequestPayload extends YkcV20BasePayload<YkcV20LoginRequestDetail> {

    /**
     * 默认构造函数
     */
    public YkcV20LoginRequestPayload() {
        super();
        setFrameType("01");
    }
     ...
     */
    public YkcV20LoginRequestPayload(YkcV20LoginRequestDetail detail) {
        super();
        setFrameType("01");
        setDetail(detail);
    }
