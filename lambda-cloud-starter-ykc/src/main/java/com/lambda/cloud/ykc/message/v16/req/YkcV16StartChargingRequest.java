...
@Setter
@ToString
@ProtocolPayload(frameType = "0x31", name = "充电桩主动申请启动充电", description = "用户通过帐号密码及刷卡在充电桩上操作请求充电", version = "1.6")
public class YkcV16StartChargingRequest {
