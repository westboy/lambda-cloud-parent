...
@Getter
@Setter
@ProtocolPayload(frameType = "0x21", name = "充电机中止", description = "充电机中止充电原因上送", version = "1.6")
public class YkcV16ChargerAbortUp {
    ...
    /** 中止充电错误原因 (1字节) */
    @ProtocolField(order = 6, length = 1, computed = true, dataType = ProtocolDataType.UINT8, description = "中止充电错误原因")
