...
@Setter
@ToString
@ProtocolPayload(frameType = "A7", name = "远程启机命令回复", description = "桩向平台回复远程启机命令结果")
public class YkcV20RemoteStartReplyUp {
     ...
     * 0x01成功
     */
    @ProtocolField(order = 4, length = 1, dataType = ProtocolDataType.UINT8, description = "启机结果")
