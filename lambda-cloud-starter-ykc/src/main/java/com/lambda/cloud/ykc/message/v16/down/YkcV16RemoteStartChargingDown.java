...
/**
 * 云快充1.6协议运营平台远程控制启机消息体
 * <p>
 * 对应协议帧类型 0x34，当用户通过远程启动充电时，发送本命令（平台->充电桩）
 * </p>
 *
 * @author Jin
 */
...
@Setter
@ToString
@ProtocolPayload(frameType = "0x34", name = "运营平台远程控制启机", description = "当用户通过远程启动充电时，发送本命令", version = "1.6")
public class YkcV16RemoteStartChargingDown {
