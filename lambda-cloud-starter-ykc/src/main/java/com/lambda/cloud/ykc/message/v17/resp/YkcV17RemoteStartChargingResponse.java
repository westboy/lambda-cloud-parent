...
@Setter
@ToString
@ProtocolPayload(frameType = "0x33", name = "远程启动充电命令回复", description = "远程启动充电命令回复", version = "1.7")
public class YkcV17RemoteStartChargingResponse {
    ...
    /**
     * 失败原因 (1字节)
     * BIN码: 0x00 无, 0x01 设备编号不匹配, 0x02 枪已在充电,
     * 0x03 设备故障, 0x04 设备离线, 0x05 未插枪
     */
