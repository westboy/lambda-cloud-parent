 ...
 * @author Jin
 */
public class YkcV17LoginRequestPayload extends YkcV17BasePayload<YkcV17LoginRequestDetail> {
    /**
     * 带消息体的构造函数
     *
     * @param body 登录请求消息体
     */
    public YkcV17LoginRequestPayload(YkcV17LoginRequestDetail body) {
