...
import com.lamuda.cloud.core.propertis.CorsProperties;
import com.lamuda.cloud.gateway.filter.*;
import com.lamuda.cloud.gateway.predicate.BackendRoutePredicateFactory;
import com.lamuda.cloud.gateway.properties.GatewayFirewallProperties;
import com.lamuda.cloud.gateway.service.RouterEnhancer;
...
public class GatewayAutoConfiguration {
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnProperty(name = "lamuda.api-docs.production", havingValue = "true")
    ...
    @Bean
    @ConfigurationProperties(prefix = "lamuda.web.cors")
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "lamuda.web.firewall", name = "enabled")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "lamuda.web.cors", name = "enabled", havingValue = "true")
