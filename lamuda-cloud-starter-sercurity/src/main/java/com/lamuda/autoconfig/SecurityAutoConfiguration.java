...
import com.lamuda.security.inteceptor.SecureExtendInterceptor;
import com.lamuda.security.inteceptor.SecureInterceptor;
import com.lamuda.security.password.HmacShaEncoder;
import com.lamuda.security.password.StandardPasswordEncoder;
import com.lamuda.security.service.HmacClientService;
import com.lamuda.security.service.UserDetailService;
import com.lamuda.security.web.SecurityLockingStrategy;
import com.lamuda.security.web.authentication.DefaultAuthenticationProcessingFilter;
import com.lamuda.security.web.authentication.DefaultLogoutFilter;
import com.lamuda.security.web.authentication.handler.DefaultAuthenticationFailureHandler;
import com.lamuda.security.web.authentication.handler.DefaultAuthenticationSuccessHandler;
import com.lamuda.security.web.authentication.handler.DefaultLogoutHandler;
import com.lamuda.security.web.authentication.handler.DefaultLogoutSuccessHandler;
import com.lamuda.security.web.authentication.locking.RedisLockingStrategy;
import com.lamuda.security.web.hmac.HmacAuthenticationProcessingFilter;
import com.lamuda.security.web.hmac.handler.HmacAuthenticationSuccessHandler;
import com.lamuda.security.web.hmac.service.MemoryHmacClientService;
import com.lamuda.security.web.verify.VerifyCodeFilter;
import com.lamuda.security.web.verify.service.VerifyCodeService;
import com.lamuda.security.web.verify.service.captcha.CaptchaVerifyCodeGenerateImpl;
import com.lamuda.security.web.verify.service.captcha.CaptchaVerifyCodeValidationImpl;
import com.lamuda.security.web.verify.store.CaptchaStore;
import com.lamuda.security.web.verify.store.RedisCaptchaStore;
import com.lamuda.security.web.xss.XSSDefendFilter;
...
public class SecurityAutoConfiguration {
    ...
    @Bean
    @Primary
    @ConfigurationProperties(prefix = "lamuda.security.sa-token")
    public SaTokenConfig getSaTokenConfig() {
        return new SaTokenConfig();
    }

    @Bean
    @ConditionalOnProperty(prefix = "lamuda.security.xss-protected", name = "enabled")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "lamuda.security.sa-token", name = "check-same-token")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "lamuda.security.form", name = "enabled")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "lamuda.security.hmac", name = "enabled")
