...
import static com.lamuda.cloud.kafka.delayqueue.DelayConsumerRecord.DELAY_TOPIC;
...
public class DelayMonitorService {
    ...
    public Properties getConsumerProperties() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "lamuda-cloud-delay-consumer");
        return properties;
    }
